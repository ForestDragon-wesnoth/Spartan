...
--hacky workaround - named as "gold" in the theme, to make it work properly in replays
...
--hacky workaround - named as "villages" in the theme, to make it work properly in replays
...
--hacky workaround - named as "units" in the theme, to make it work properly in replays
function wesnoth.interface.game_display.units()
	-- Display for the viewing side, not the current side
	local viewing_side = wesnoth.interface.get_viewing_side()
...
--hacky workaround - named as "upkeep" in the theme, to make it work properly in replays
...
--hacky workaround - named as "income" in the theme, to make it work properly in replays
